sap.ui.define([
	"cap/catalogo_domande/Catalogo_Domande/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("testo").length, 1, "The sorting by testo returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by testo and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("testo");
