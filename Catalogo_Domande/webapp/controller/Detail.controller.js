/*global location */
sap.ui.define([
	"cap/catalogo_domande/Catalogo_Domande/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"cap/catalogo_domande/Catalogo_Domande/model/formatter",
	"sap/m/MessageBox",
	"sap/m/MessageToast"
], function (BaseController, JSONModel, formatter, MessageBox, MessageToast) {
	"use strict";

	return BaseController.extend("cap.catalogo_domande.Catalogo_Domande.controller.Detail", {
		...
		onDelete: function () {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/testo"),
		...
		onEditRisposta: function () {
			this.getModel("appView").setProperty("/addEnabled", false);
			var sObjectPath = this.getView().byId("lineItemsList").getSelectedContextPaths()[0];
			this.getRouter().getTargets().display("createRisposta", {
				mode: "update",
				objectPath: sObjectPath
			});
		},
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("Domande", oParameter);
				this._sPath = sObjectPath;
