sap.ui.define([
	...
	return BaseController.extend("cap.catalogo_domande.Catalogo_Domande.controller.CreateEntityRisposta", {
		...
		onInit: function () {
			var that = this;
			this.getRouter().getTargets().getTarget("createRisposta").attachDisplay(null, this._onDisplay, this);
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry(sap.ui.getCore().tipo, {
				success: this._fnEntityCreated.bind(this),
				error: this._fnEntityCreationFailed.bind(this)
			});
			if(sap.ui.getCore().tipo === "Risposte")
				oContext.getModel().setProperty(oContext.getPath()+"/domanda_ID",oContext.getModel().getObject("/"+sap.ui.getCore().sPathDomanda).ID);
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey(sap.ui.getCore().tipo, oData);
