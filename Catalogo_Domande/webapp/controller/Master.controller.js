...
sap.ui.define([
	...
	return BaseController.extend("cap.catalogo_domande.Catalogo_Domande.controller.Master", {
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("testo", FilterOperator.Contains, sQuery)];
			} else {
