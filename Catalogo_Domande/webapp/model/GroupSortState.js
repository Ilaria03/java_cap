sap.ui.define([
	...
	return BaseObject.extend("cap.catalogo_domande.Catalogo_Domande.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias cap.catalogo_domande.Catalogo_Domande.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "testo");
			}
